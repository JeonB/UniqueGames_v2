...
* 로그인과 회원가입
  ...
  - 구글 이메일 인증과 카카오 주소 찾기 api를 이용하여 보다 엄격하고 구체적인 회원가입 요청을 합니다.
...
* ADMIN PAGE
  - 관리자로 로그인 했을 때만 이동이 가능합니다.
  - 회원관리 / 게임관리 페이지를 통해 현재 가입된 일반회원과 법인회원의 정보, 등록된 게임들의 정보를 나열하고 페이징 처리합니다.
  - 게임 등록 및 수정은 관리자만 할 수 있도록 하여 더 좋은 퀄리티의 게임을 일반회원에게 제공할 수 있습니다.
  - 정산 현황 페이지를 통해 이번 달 게임별로 후원받은 금액을 확인 할 수 있습니다.
