...
<head>
	...
	<script src="/js/join_jquery.js"></script>
	<script>
...
<body>
	...
	<section id="content-1">
		<p id="intro">회원탈퇴</p>
		<form action="delete_check" name="loginForm" method="post">
			<div id="div-delete">
				...
				<ul>
					...
					<li>
						<input type="text" id="input-common" name="member_id" value="${member.member_id }" disabled>
					...
					<li id="intro-3">
						<p id="delete-id">${member.member_id }님!</p>
