...
CREATE  TABLE  LIKE (
                    ID INT NSIGNED NOT NULL AUTO_INCREMENT PRIMARY KEY,
                    G_ID INT(3)  NOT NULL,
                    MEMBER_ID VARCHAR(15) NOT NULL,
                    CONSTRAINT FK_GAME_LIST_GID FOREIGN KEY (G_ID) REFERENCES GAME (ID)  ON UPDATE CASCADE ON DELETE CASCADE,
                    CONSTRAINT FK_GAME_LIST_MID FOREIGN KEY (MEMBER_ID) REFERENCES MEMBER (MEMBER_ID)  ON UPDATE CASCADE ON DELETE CASCADE
);
